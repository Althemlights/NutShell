...
//*# Library Name   : ts5n28hpcplvta128x8m2f (user specify : TS5N28HPCPLVTA128X8M2F)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/09/01, 00:03:38										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA128X8M2F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA128X8M2F_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.3390;
    specparam tCKH = 0.1525;
    specparam tCKL = 0.1525;
    specparam tCS = 0.1184;
    specparam tCH = 0.0335;
    specparam tWS = 0.0843;
    specparam tWH = 0.0783;
    specparam tAS = 0.0613;
    specparam tAH = 0.0761;
    specparam tDS = 0.0331;
    specparam tDH = 0.0988;
    specparam tCD = 0.2487;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2487;
`else    
    specparam tHOLD = 0.1392;
`endif    

...
//*# Library Name   : ts5n28hpcplvta64x32m2f (user specify : TS5N28HPCPLVTA64X32M2F)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/09/01, 00:03:31										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA64X32M2F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA64X32M2F_fault.cde";
`endif
...
specify
    ...
    specparam tDS = 0.0308;
    specparam tDH = 0.1037;
    specparam tCD = 0.2332;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2332;
`else    
    specparam tHOLD = 0.1416;
`endif    

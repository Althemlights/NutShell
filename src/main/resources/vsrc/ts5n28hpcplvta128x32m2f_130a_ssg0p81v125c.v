...
//*# Generated Time : 2020/09/01, 00:03:44										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
specify
    ...
    specparam tCYC = 0.3474;
    specparam tCKH = 0.1563;
    specparam tCKL = 0.1563;
    ...
    specparam tDS = 0.0304;
    specparam tDH = 0.1037;
    specparam tCD = 0.2567;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2567;
`else    
    specparam tHOLD = 0.1435;
`endif    

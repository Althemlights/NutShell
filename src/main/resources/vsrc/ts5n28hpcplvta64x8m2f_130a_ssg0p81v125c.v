...
//*# Library Name   : ts5n28hpcplvta64x8m2f (user specify : TS5N28HPCPLVTA64X8M2F)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/09/01, 00:03:23										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA64X8M2F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA64X8M2F_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.2826;
    specparam tCKH = 0.1272;
    specparam tCKL = 0.1272;
    specparam tCS = 0.1117;
    specparam tCH = 0.0335;
    specparam tWS = 0.0842;
    specparam tWH = 0.0782;
    specparam tAS = 0.0547;
    specparam tAH = 0.0760;
    specparam tDS = 0.0332;
    specparam tDH = 0.0988;
    specparam tCD = 0.2247;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2247;
`else    
    specparam tHOLD = 0.1373;
`endif    

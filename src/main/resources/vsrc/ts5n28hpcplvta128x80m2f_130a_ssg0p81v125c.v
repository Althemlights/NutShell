...
//*# Library Name   : ts5n28hpcplvta128x80m2f (user specify : TS5N28HPCPLVTA128X80M2F)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/09/01, 00:03:57										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA128X80M2F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA128X80M2F_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.3641;
    specparam tCKH = 0.1638;
    specparam tCKL = 0.1638;
    specparam tCS = 0.1184;
    specparam tCH = 0.0335;
    specparam tWS = 0.0842;
    specparam tWH = 0.0784;
    specparam tAS = 0.0614;
    specparam tAH = 0.0762;
    specparam tDS = 0.0251;
    specparam tDH = 0.1136;
    specparam tCD = 0.2727;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2727;
`else    
    specparam tHOLD = 0.1520;
`endif    

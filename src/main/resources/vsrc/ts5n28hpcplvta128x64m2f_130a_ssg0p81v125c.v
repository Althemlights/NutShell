...
//*# Generated Time : 2020/09/01, 00:03:51										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
specify
    ...
    specparam tCYC = 0.3585;
    specparam tCKH = 0.1613;
    specparam tCKL = 0.1613;
    ...
    specparam tDS = 0.0269;
    specparam tDH = 0.1103;
    specparam tCD = 0.2673;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2673;
`else    
    specparam tHOLD = 0.1492;
`endif    

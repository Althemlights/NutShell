...
//     val d    = Bool()//UInt(1.W)      dirty
//     val a    = Bool()//UInt(1.W)      access
//     val g    = Bool()//UInt(1.W)      global
//     val u    = Bool()//UInt(1.W)      user
//     val x    = Bool()//UInt(1.W)       exe
//     val w    = Bool()//UInt(1.W)      write
//     val r    = Bool()//UInt(1.W)        read
//     val v    = Bool()//UInt(1.W)        valid
//   }
